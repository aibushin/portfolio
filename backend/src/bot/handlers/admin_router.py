...
from src.bot.keyboards.kbs import admin_keyboard, main_keyboard
from src.configs import settings

tg_admin_router = Router(name="admin_router")


@tg_admin_router.message(F.text == "🔑 Админ панель", F.from_user.id.in_([settings.tg_admin_id]))
...
@tg_admin_router.callback_query(F.data == "back_home")
